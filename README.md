...
6. Launch the program from your Start menu once the installation finishes.
...
No. The tool only reads your files. It does not delete, edit, or move your work.

Can it scan multiple languages?
Yes. The tool understands many common coding languages through tree-sitter technology.

What if the scan fails?
Check that you have permission to read the folder you chose. Ensure no other programs are currently editing those files. Try running the app again.

Does it need the cloud?
The app runs on your computer. It does not transmit your source code to external servers.
